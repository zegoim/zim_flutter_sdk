...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    FlutterMethodChannel *channel =
        [FlutterMethodChannel methodChannelWithName:@"zego_zim_plugin"
                                    binaryMessenger:[registrar messenger]];
    instance = [[ZegoZimPlugin alloc] init];
    [registrar addMethodCallDelegate:instance channel:channel];
    instance.methodChannel = channel;
    FlutterEventChannel *eventChannel =
        [FlutterEventChannel eventChannelWithName:@"zim_event_handler"
                                  binaryMessenger:[registrar messenger]];
...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    NSMethodSignature *signature =
        [[ZIMMethodHandler sharedInstance] methodSignatureForSelector:selector];
