...
template <typename SchemaDocumentType> struct SchemaValidationContext {
    ...
    SchemaValidationContext(SchemaValidatorFactoryType &f, const SchemaType *s)
        : factory(f), schema(s), valueSchema(), invalidKeyword(), hasher(), arrayElementHashCodes(),
  ...
  public:
    ...
    Schema(SchemaDocumentType *schemaDocument, const PointerType &p, const ValueType &value,
        ...
        : allocator_(allocator), enum_(), enumCount_(), not_(),
          ...
          maxItems_(SizeType(~0)), additionalItems_(true), uniqueItems_(false), pattern_(),
  ...
  public:
    ...
    */
    GenericSchemaValidator(const SchemaDocumentType &schemaDocument, StateAllocator *allocator = 0,
        ...
        : schemaDocument_(&schemaDocument), root_(schemaDocument.GetRoot()),
          outputHandler_(GetNullHandler()), stateAllocator_(allocator), ownStateAllocator_(0),
    ...
    */
    GenericSchemaValidator(const SchemaDocumentType &schemaDocument, OutputHandler &outputHandler,
                           ...
                           size_t documentStackCapacity = kDefaultDocumentStackCapacity)
        : schemaDocument_(&schemaDocument), root_(schemaDocument.GetRoot()),
          outputHandler_(outputHandler), stateAllocator_(allocator), ownStateAllocator_(0),
          schemaStack_(allocator, schemaStackCapacity),
          documentStack_(allocator, documentStackCapacity), valid_(true)
#if RAPIDJSON_SCHEMA_VERBOSE
          ,
...
#undef RAPIDJSON_SCHEMA_HANDLE_VALUE_
  ...
  private:
    ...
    GenericSchemaValidator(const SchemaDocumentType &schemaDocument, const SchemaType &root,
                           ...
                           size_t schemaStackCapacity = kDefaultSchemaStackCapacity,
                           size_t documentStackCapacity = kDefaultDocumentStackCapacity)
        : schemaDocument_(&schemaDocument), root_(root), outputHandler_(GetNullHandler()),
