...
std::string ZegoServerAssistantImpl::GenerateToken(uint32_t appID, const std::string &userID,
...
std::string ZegoServerAssistantImpl::TokenToJson(const TokenParams &params) {
    ...
    JSON_TOOLS::AddMember(document, "nonce", 100, allocator);
...
std::string ZegoServerAssistantImpl::AesEncrypt(const std::string &origData, const std::string &key,
                                                const std::string &iv) {
