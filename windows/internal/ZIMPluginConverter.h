...
public:
    ...
    static flutter::EncodableValue cnvZIMUserInfoPtrToObj(std::shared_ptr<ZIMUserInfo> userPtr);
    static FTArray cnvZIMUserInfoPtrListToArray(std::vector<std::shared_ptr<ZIMUserInfo>> userInfoList);
    ...
    static flutter::EncodableValue cnvZIMTipsMessageChangeInfoToMap(std::shared_ptr<ZIMTipsMessageChangeInfo> changeInfo);
    ...
    static flutter::EncodableValue cnvZIMGroupMuteInfoPtrToObj(std::shared_ptr<ZIMGroupMuteInfo> infoPtr);
