...
void ZIMPluginEventHandler::onCallStateChanged(ZIM * zim, const ZIMCallStateChangedInfo& info) {
    if (eventSink_) {
        FTMap retMap;
...
void ZIMPluginEventHandler::onCallUserStateChange(ZIM * zim, const ZIMCallUserStateChangedInfo& info) {
    if (eventSink_) {
        FTMap retMap;
