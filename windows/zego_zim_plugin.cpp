...
void ZegoZimPlugin::HandleMethodCall(
	...
	else if (method_call.method_name() == "clearConversationsAllUnreadMessageCount") {
		ZIMPluginMethodHandler::getInstance().clearConversationsAllUnreadMessageCount(argument, std::move(result));
	}
